...
class interface :
    def __init__(self, master):
        ...
        self.label_vies = tk.Label(
            ...
            bg="Violet red", 
            font=("Arial", 15))
        self.label_vies.place(x=750, y=30) #position du label 
        ...
        self.cases_cote = tk.Label (
            ...
            bg="Light goldenrod", 
            font=("Arial",10))
        self.cases_cote.place(x=720, y=100) 
        ...
        self.nb_cases_cote.place(x=750, y=120)
